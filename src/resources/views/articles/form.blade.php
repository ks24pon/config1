...
<div class="mb-4 col-lg-7 col-md-8 col-sm-9 col-xs-10 mx-auto row align-items-center ">
  <span class="col-3 text-center bg green lighten-1 text-white px-3 py-2 rounded-pill">採用形態</span>
  <div class="col-9 text-left py-2 ">
    <div class="form-check form-check-inline">
      <input type="radio" name='recruitment_id' id="recruitment1" class='form-check-input' value=1 {{ old('recruitment_id', '1') == 1 ? 'checked' : '' }}>
...
<div class="mb-4 col-lg-5 col-lg-7 col-md-8 col-sm-9 col-xs-10 mx-auto row align-items-center ">
  <span class="col-3 text-center bg green lighten-1 text-white px-3 py-2 rounded-pill">試験内容</span>
  <div class="col-9 text-left">
    <div class="form-check form-check-inline">
      <input type="radio" name='test_id' id="test1" class='form-check-input' value=1 {{ old('test_id', '1') == 1 ? 'checked' : '' }}>
...
<div class="card-body form-group text-left col-lg-8 col-md-9 col-sm-10 col-xs-12 mx-auto mt-5">
  <label class="bg green lighten-1 text-white px-4 py-2 rounded-pill mb-3">試験の内容</label>
...
<div class="card-body form-group text-left col-lg-8 col-md-9 col-sm-10 col-xs-12 mx-auto mt-4">
  <label class="bg green lighten-1 text-white px-4 py-2 rounded-pill mb-3">その他の情報</label>
...
<div class="card-body form-group text-left col-lg-8 col-md-9 col-sm-10 col-xs-12 mx-auto mt-4">
  <label class="bg green lighten-1 text-white px-4 py-2 rounded-pill mb-3">アドバイスなど</label>
